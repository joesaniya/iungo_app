...
class DateRangePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) =>
          DateRangePickerProvider(initialDateRange: initialDateRange),
      child: Consumer<DateRangePickerProvider>(
              ...
              children: [
                ...
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        _buildPresetTab(context, provider, 'Date range'),
                        ...provider.presets.map(
                          (preset) =>
                              _buildPresetTab(context, provider, preset),
                        ),
                      ],
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: provider.isDateRangeValid
                                ? () {
  ...
  Widget _buildPresetTab(
    ...
    DateRangePickerProvider provider,
    String label,
  ) {
    final isSelected =
        provider.selectedPreset == label || label == 'Date range';
    return GestureDetector(
      onTap: () => label != 'Date range' ? provider.selectPreset(label) : null,
      child: Container(
  ...
  Widget _buildDayCell(
    ...
    final isInRange = provider.isInRange(date);
    final isSelected = provider.isSelected(date);
    final isToday = _isSameDay(date, DateTime.now());

    return GestureDetector(
      onTap: isCurrentMonth ? () => provider.selectDate(date) : null,
      child: Container(
