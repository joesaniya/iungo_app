                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (provider.diversionRate!.chartData != null) ...[
                        const SizedBox(height: 12),
                        Text(
                          'Recycled: ${provider.diversionRate!.chartData!['recycled']} Kg  |  Total Waste: ${provider.diversionRate!.chartData!['total']} Kg',
                          style: AppTheme.pLight.copyWith(
                            fontSize: 12,
                            color: AppColors.textSecondary,
                          ),
