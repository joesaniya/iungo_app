...
class MonitoringServiceTab extends StatelessWidget {
  const MonitoringServiceTab({super.key});
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildFeatureItem('Real-time monitoring dashboard'),
                _buildFeatureItem('Service status indicators'),
                _buildFeatureItem('Alert notifications'),
                _buildFeatureItem('Performance metrics'),
                _buildFeatureItem('Historical data analysis'),
              ],
            ),
          ),
        ],
